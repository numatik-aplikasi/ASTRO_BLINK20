...
import { quizGamezTopics } from "@/data/menuNavigasi";

type Kelas = keyof typeof quizGamezTopics;
      ...
      <div className="relative z-10 max-w-3xl w-full px-4 py-10">
        ...
        {!selectedKelas ? (
          <div className="animate-slide-up grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-lg mx-auto">
            {(Object.keys(quizGamezTopics) as Kelas[]).map((kelas, i) => (
              <button
                key={kelas}
              ...
              >
                ...
                <p className="text-xs text-muted-foreground mt-1 font-body">
                  {quizGamezTopics[kelas].length} quiz
                </p>
              </button>
            ))}
          </div>
          ...
          <div className="animate-slide-up">
            ...
            <div className="flex flex-col gap-3">
              {quizGamezTopics[selectedKelas].map((item, i) => (
                <button
                  key={item.label}
